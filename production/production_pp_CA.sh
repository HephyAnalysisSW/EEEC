...
python genPostProcessing_pp.py --jetAlgorithm CA --input $PRODUCTION_TMP_FILE --output $OUTPUTDIR/output_${COM}_${MT}_${MW}_HARDPT${PTMIN}to${PTMAX}_MPI${MPISWITCH}_HAD${HADSWITCH}_CA_$POSTFIX
