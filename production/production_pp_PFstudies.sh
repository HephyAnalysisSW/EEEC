...
python genPostProcessing_pp_PFstudies.py --input $PRODUCTION_TMP_FILE --output $OUTPUTDIR/outputPFstudies_${COM}_${MT}_${MW}_HARDPT${PTMIN}to${PTMAX}_MPI${MPISWITCH}_HAD${HADSWITCH}_$POSTFIX
