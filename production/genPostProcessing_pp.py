...
while reader.run( ):
    ...
    if jet_top is not None:
        # Get triplets
        scale = jet_top.pt()
        triplets_top, weights_top = ec.getTriplets_pp(scale, jet_top.constituents(), n=1, max_zeta=max_zeta, max_delta_zeta=None, delta_legs=None, shortest_side=None)
        # Fill jet hists
    ...
    if jet_antitop is not None:
        # Get triplets
        scale = jet_top.pt()
        triplets_antitop, weights_antitop = ec.getTriplets_pp(scale, jet_antitop.constituents(), n=1, max_zeta=max_zeta, max_delta_zeta=None, delta_legs=None, shortest_side=None)
        # Fill jet hists
